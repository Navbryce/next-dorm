...
import {Comment, Post, Visibility} from "../model/types";
...
const PostComponent = ({post}: { post: Post }) => {
  ...
  const createCommentCb = useCallback(async (values: Values) => {
    if (!comments) {
      return;
    }
  ...
  return <div class="bg-primary-600 h-full overflow-y-scroll">
